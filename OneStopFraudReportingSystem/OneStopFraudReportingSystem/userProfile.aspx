<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="userProfile.aspx.cs" Inherits="OneStopFraudReportingSystem.userProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main1" runat="server">
    <div class="container">
        <ul class="nav nav-tabs" style="background-color: #F9F9F9;">
            <li class="active">
                <asp:LinkButton ID="lnkUserProfile" runat="server" OnClick="lnkUserProfile_Click"><i class="fa fa fa-user bigger-120"></i> User Profile</asp:LinkButton>
            </li>
            <li>
                <asp:LinkButton ID="lnkUserSetPass" runat="server" OnClick="lnkUserSetPass_Click"><i class="fa fa fa-key bigger-120"></i> Set Password</asp:LinkButton>
            </li>
        </ul>

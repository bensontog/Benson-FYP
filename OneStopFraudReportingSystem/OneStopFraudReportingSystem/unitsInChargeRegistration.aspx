<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="unitsInChargeRegistration.aspx.cs" Inherits="OneStopFraudReportingSystem.unitsInChargeRegistration" %>
                            ...
                            <div class="row">
                                <div class="col">
                                    <center>
                                        ...
                                        <h4>Units In-Charge Registration</h4>
                                    </center>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="*Please select the &lt;b&gt;Department&lt;/b&gt;" ControlToValidate="ddlDepartment" Display="Dynamic" CssClass="word" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*Please select the &lt;b&gt;Department&lt;/b&gt;" ControlToValidate="ddlPosition" Display="Dynamic" CssClass="word" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="unitsInChargeProfile.aspx.cs" Inherits="OneStopFraudReportingSystem.unitsInChargeProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main1" runat="server">
    <div class="container">
        <ul class="nav nav-tabs" style="background-color: #F9F9F9;">
            <li class="active">
                <asp:LinkButton ID="lnkUICProfile" runat="server" OnClick="lnkUnitsInChargeProfile_Click"><i class="fa fa fa-user bigger-120"></i> Units In-Charge Profile</asp:LinkButton>
            </li>
            <li>

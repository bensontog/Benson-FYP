<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="adminRegistration.aspx.cs" Inherits="OneStopFraudReportingSystem.adminRegistration" %>
                ...
                <div class="col-md-7 mx-auto">
                    <div>
                        <div class="card-body rounded border">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Label ID="lblIcNo" runat="server" Text="Ic" Font-Bold="true"></asp:Label>
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="**Please follow the format XXXXXX-XX-XXXX in digit" Display="Dynamic" CssClass="word" ControlToValidate="txtIcNo" ValidationExpression="\d{6}\-\d{2}\-\d{4}" SetFocusOnError="True"></asp:RegularExpressionValidator>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ErrorMessage="*Please follow the format XXX-XXXXXXX or XXX-XXXXXXXX in digit" CssClass="word" Display="Dynamic" ValidationExpression="\d{3}\-\d{7,8}" ControlToValidate="txtPhone"></asp:RegularExpressionValidator>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <asp:DropDownList ID="ddlPosition" runat="server" class="form-control">
                                            ...
                                            <asp:ListItem>Normal Admin</asp:ListItem>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Please enter the &lt;b&gt;Address&lt;/b&gt;" ControlToValidate="txtAddress" CssClass="word" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>

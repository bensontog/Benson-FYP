<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="deleteVictim.aspx.cs" Inherits="OneStopFraudReportingSystem.deleteVictim" %>
                ...
                <div class="col-md-7 mx-auto">
                    <div>
                        <div class="card-body rounded border">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Label ID="lblVID" runat="server" Text="Victim ID" Font-Bold="true" Font-Strikeout="False"></asp:Label>

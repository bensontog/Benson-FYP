<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="casesReportDetails.aspx.cs" Inherits="OneStopFraudReportingSystem.casesReportDetails" %>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-6 text-center">
                    <h1 class="alert-heading-section" style="font-size: 40pt;">Cases Report</h1>
                    ...
                    <div style="padding-bottom: 20px;">
                        ...
                        <p>
                            <asp:Label ID="lblUID" runat="server" Text="Victim ID: " Font-Bold="true"></asp:Label>
                            &nbsp;

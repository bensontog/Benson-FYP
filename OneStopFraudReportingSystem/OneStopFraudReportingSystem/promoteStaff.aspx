<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="promoteStaff.aspx.cs" Inherits="OneStopFraudReportingSystem.promoteSatff" %>
                ...
                <div class="col-md-7 mx-auto">
                    <div>
                        <div class="card-body rounded border">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <asp:Label ID="lblUID" runat="server" Text="Staff ID" Font-Bold="true" Font-Strikeout="False"></asp:Label>

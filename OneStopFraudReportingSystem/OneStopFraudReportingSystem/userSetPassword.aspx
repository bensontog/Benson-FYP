<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="userSetPassword.aspx.cs" Inherits="OneStopFraudReportingSystem.userSetPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main1" runat="server">
    <div class="container">
        <ul class="nav nav-tabs" style="background-color:#F9F9F9;">
            <li>
                <asp:LinkButton ID="lnkUserProfile" runat="server" OnClick="lnkUserProfile_Click" CausesValidation="false"><i class="fa fa fa-user bigger-120"></i> User Profile</asp:LinkButton>
            </li>
            <li class="active">
